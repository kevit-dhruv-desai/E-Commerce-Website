              ...
              <div className={styles.cartitem}>
                ...
                <div className={styles.cartinfo}>
                  ...
                  <div className={styles.quantitycontent}>
                    <button onClick={() => dispatch(decreaseQuantity(items))} className={styles.commonbtn}>-</button>
                    <span>Quantity: {items.quantity}</span>

                    <button onClick={() => dispatch(increaseQuantity(items))} className={styles.commonbtn}>+</button>
                    <button onClick={() => { dispatch(removeFromCart(items));}}className={styles.commonbtn}>
                      <img src={remove} alt="remove" height="30px" width="30px"/>
                    </button>
                  </div>
                </div>
              </div>
